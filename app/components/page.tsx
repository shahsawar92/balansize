        ...
        <div
          ...
          <ol className='mt-8 space-y-6'>
              ...
              <div className='flex flex-wrap gap-2'>
                <select
                  ...
                  className={clsx(
                    ...
                    "focus:border-primary-400 focus:ring-primary-400 focus:brown-none focus:ring"
                  )}
            ...
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                <Button variant='brown'>Primary Variant</Button>
                <Button variant='brown' isDarkBg={mode === "dark"}>
                  brown Variant
                </Button>
                <Button variant='brown' isDarkBg={mode === "dark"}>
                  Ghost Variant
              ...
              <div className='flex flex-wrap gap-2'>
                <Button variant='brown' leftIcon={Plus} rightIcon={ArrowRight}>
                  Icon
                </Button>
                <Button
                  variant='brown'
              ...
              <div className='!mt-4 flex flex-wrap gap-2'>
                <Button sizeOfButton='sm' variant='brown'>
                  Small Size
                </Button>
                <Button
                  sizeOfButton='sm'
                ...
                <Button sizeOfButton='sm' variant='dark'>
                  Small Size
                </Button>
                <Button sizeOfButton='sm' variant='light'>
                  Small Size
                </Button>
              </div>
              <div className='flex flex-wrap gap-2'>
              ...
              <div className='!mt-4 flex flex-wrap gap-2'>
                ...
                <Button disabled variant='brown' isDarkBg={mode === "dark"}>
                  Disabled
                </Button>
                <Button disabled variant='light' isDarkBg={mode === "dark"}>
                  Disabled
                </Button>
              ...
              <div className='flex flex-wrap gap-2'>
                ...
                <Button isLoading variant='brown' isDarkBg={mode === "dark"}>
                  Disabled
                </Button>
                <Button isLoading variant='light' isDarkBg={mode === "dark"}>
                  Disabled
                </Button>
            ...
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <IconButton variant='dark' icon={Laptop} />
                <IconButton variant='dark' icon={Phone} />
